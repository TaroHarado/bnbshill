...
const CONFIG = {
  ...
  subtitle:
    "We return 100% of $SHILL fees from four.meme back to creators who post short clips with our logo.",
  links: {
    pump: "https://four.meme/", // e.g. https://four.meme/coin/...
    x: "https://x.com/bnb__shill",
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 grid md:grid-cols-2 gap-6 text-sm">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 text-slate-300">
              <li><a className="hover:underline text-violet-400" href={CONFIG.links.pump}>four.meme</a></li>
